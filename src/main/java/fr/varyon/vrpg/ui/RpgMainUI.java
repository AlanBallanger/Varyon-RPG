...
public final class RpgMainUI extends InteractiveCustomUIPage<RpgMainUI.Data> {
    ...
    private static final String[][] TREE_NODES = {
        ...
        {"2",  "Minerai Fantomatique",      "Passif", "Au fond des galeries, certains minerais brillent d’une lueur qui n’appartient pas à ce monde.", "Chance d’obtenir un Minerai Fantomatique en récoltant.", "Jobs_Icons/Ore_Ghost.png"},
    ...
    private static final String[][] FERMIER_TREE_NODES = {
        ...
        {"3",  "Graines Fantomatiques",  "Passif", "Ces semences translucides ne se révèlent qu'aux mains qui ont vraiment travaillé la terre.", "Chance d'obtenir des Graines Fantomatiques lors des récoltes.",         "Jobs_Icons/Seed_Ghost.png"},
    ...
    private static final String[][] FORESTIER_TREE_NODES = {
        ...
        {"2",  "Bûches Fantomatiques",       "Passif", "Certains arbres anciens laissent derrière eux plus que du bois.",    "Chance d'obtenir une Bûche Fantomatique en coupant des arbres.",                                              "Jobs_Icons/Log_Ghost.png"},
    ...
    private static final String[][] CHASSEUR_TREE_NODES = {
        ...
        {"2",  "Cuir Fantomatique",    "Passif", "Les créatures les plus rares laissent parfois une dépouille translucide.", "Chance d'obtenir du Cuir Fantomatique sur les créatures.",                                       "Jobs_Icons/Hide_Ghost.png"},
