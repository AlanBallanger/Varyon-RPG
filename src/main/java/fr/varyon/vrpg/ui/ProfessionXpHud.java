...
public final class ProfessionXpHud extends CustomUIHud {
    ...
    private static final PatchStyle PANEL_BG = new PatchStyle()
        .setTexturePath(Value.of("Common/DropdownBox.png"))
        .setBorder(Value.of(16))
        .setColor(Value.of("#00000052"));
    ...
    private void applyBars(@Nonnull UICommandBuilder builder) {
        ...
        builder.setObject("#XPPanel.Background", PANEL_BG);
    ...
    private void applySlot(@Nonnull UICommandBuilder builder, int slot,
        ...
        builder.setObject("#Job" + slot + "LevelBg.Background",
            new PatchStyle().setColor(Value.of("#2E7D4FFF")));
        ...
        builder.set("#Job" + slot + "Name.TextSpans",
            Message.raw(profession.getDisplayName().toUpperCase(Locale.FRENCH)));
        ...
        if (!jobId.equals(prevId)) {
            builder.set("#Job" + slot + "Icon.Slots",
                List.of(new ItemGridSlot(new ItemStack(profession.getIconItemId(), 1))));
    ...
    private void hideSlot(@Nonnull UICommandBuilder builder, int slot) {
        ...
        builder.setObject("#Job" + slot + "LevelBg.Background", TRANSPARENT);
    }
}
