...
public final class ChasseurGuardianTickSystem extends EntityTickingSystem<EntityStore> {
    ...
    public ChasseurGuardianTickSystem(ChasseurGuardianManager guardianManager) {
